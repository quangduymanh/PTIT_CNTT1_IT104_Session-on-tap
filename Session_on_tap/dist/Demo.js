...
Chọn: `);
        switch (choice) {
            case '1':
                ...
                break;
            case '2':
                airline.addDomesticFlight();
                break;
            case '3':
                airline.addInternationalFlight();
                break;
            case '4':
                airline.createBooking();
                break;
            case '5':
                airline.cancelBooking();
                break;
            case '6':
                airline.showAvailableFlights();
                break;
            case '7':
                airline.showPassengerBookings();
                break;
            case '8':
                airline.calculateRevenue();
                break;
            case '9':
                airline.updateSeats();
                break;
